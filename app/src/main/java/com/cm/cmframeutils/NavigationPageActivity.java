...
import sliderView.ViewHelper;
import utlis.PreferencesUtils;


public class NavigationPageActivity extends AppCompatActivity implements View.OnClickListener,ViewPager.OnPageChangeListener {
    ...
    private void initView() {
        ...
        pager = ViewPager.class.cast(findViewById(R.id.pager)) ;
    ...
    private void endTutorial(){
        PreferencesUtils.putBoolean(NavigationPageActivity.this, "isFirst", false);
        startActivity(new Intent(NavigationPageActivity.this, MainActivity.class));
        finish();
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = ProductTourFragment.newInstance(R.layout.navigationpage_fragment1);
                    break;
                case 1:
                    tp = ProductTourFragment.newInstance(R.layout.navigationpage_fragment2);
                    break;
                case 2:
                    tp = ProductTourFragment.newInstance(R.layout.navigationpage_fragment3);
                    break;
                case 3:
                    tp = ProductTourFragment.newInstance(R.layout.navigationpage_fragment4);
                    break;
                case 4:
                    tp = ProductTourFragment.newInstance(R.layout.navigationpage_fragment5);
                    break;
            }
