...
/**
 * ProjectName：MyTestAppDemo
 * PackageName：com.qdp.mytestappdemo.customview
 * FileName：RippleView.java
 * Date：2015/8/12 45
 * Author：大鹏
 * ClassName:RippleView
 */
public class MaterialRelatveLayoutView extends RelativeLayout {
    private int WIDTH;
    private int HEIGHT;
    ...
    public MaterialRelatveLayoutView(Context context) {
        super(context);
    }

    public MaterialRelatveLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MaterialRelatveLayoutView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, getResources().getColor(R.color.material_relatvelayout_color));
    ...
    public interface OnRippleCompleteListener {
        void onComplete(MaterialRelatveLayoutView rippleView);
    }
